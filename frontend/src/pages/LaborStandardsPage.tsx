    ...
    <section className="grid gap-4 xl:grid-cols-[minmax(0,1.45fr)_minmax(330px,.75fr)]">
      ...
      <Card className="h-fit border-apex/20 xl:sticky xl:top-20">
        ...
        <dl className="mt-5 divide-y divide-line text-sm">
          ...
          {market && <div className="flex justify-between gap-3 py-3"><dt className="text-muted">Публичные цены по России</dt><dd className="text-right font-bold text-success">{marketRange(market.priceMin, market.priceMax)}</dd></div>}
        </dl>
