...
export type DiagnosticSummary = { id: number; car_id: number; service_order_id: number | null; mileage: number | null; status: "draft" | "completed"; created_at: string; updated_at: string; completed_at: string | null; brand: string; model: string; plate_number: string | null; vin: string | null; customer_name: string | null; customer_phone: string | null; checked: number; total: number; critical: number; attention: number };
