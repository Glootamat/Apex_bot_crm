...
export type AppOutlet = { openEntity: (value: NonNullable<EntityModalState>) => void };
...
export function AppShell() {
  ...
  return <div className="min-h-dvh bg-canvas text-white">
    ...
    <div className="lg:pl-72">
      ...
      <main id="main-content" key={location.pathname} className="mx-auto w-full max-w-[1500px] px-4 py-6 pb-24 sm:px-6 lg:px-8 lg:pb-8"><Outlet context={{ openEntity: setEntity } satisfies AppOutlet} /></main>
    </div>
